  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <article className="rounded-[2rem] border border-[#ead8df] bg-[#fff8fa] p-8 text-center">
          <p className="mx-auto max-w-4xl font-display text-3xl font-semibold leading-tight text-[#130f12] md:text-4xl lg:text-5xl">
            "{featured.quote}"
          </p>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          {rest.map((testimonial) => (
            <article
              ...
              className="rounded-[2rem] border border-[#ead8df] bg-white p-7"
            >
